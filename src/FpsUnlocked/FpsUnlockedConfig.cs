...
namespace FpsUnlocked
{
    public class FpsUnlockedConfig : ModConfig
    {
        ...
        [Client, Label("Frame Rate Mode"), Description("VSync = vanilla frame pacing and display synchronization, Capped = custom limit, Uncapped = no limit."), Options("VSync (Vanilla)", "Capped", "Uncapped")]
